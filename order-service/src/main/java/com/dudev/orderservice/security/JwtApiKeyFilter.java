package com.dudev.orderservice.security;
...
/**
 * Фильтр Spring Security, реализующий поддержку:
 *
 * <ul>
 *   <li>JWT‑токенов (заголовок {@code Authorization: Bearer …})</li>
 *   <li>API‑ключей (заголовок {@code X-API-Key})</li>
 * </ul>
 *
 * При валидном JWT заполняет {@link UserContextHolder} данными пользователя.
 *
 * @see JwtService
